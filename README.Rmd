...
[![github-action-status](https://img.shields.io/badge/-GitHub Actions-yellow?style=for-the-badge&logo=github)](https://github.com/trang1618/treeheatr/actions)
...
* The decision tree is computed with `partykit::ctree()` and plotted with the well-documented and flexible [**ggparty**](https://cran.r-project.org/web/packages/ggparty/index.html) package.
